 ...
 * @since Mar 27, 2026
 * NDSgmsController.java
 *
 * Controller class for the Nintendo Ds Game Management System. This class handles every user interaction within the
 * application, while also connecting the GUI to the database. Allows the user to add, view, update, remove and filter
 * Ds games within the system.
 */
...
/**
 * Observable list that stores Ds games for user and is connected to the TableView
 *
 */
public class NDSgmsController {
    private ObservableList<DsGame> dsGameList = FXCollections.observableArrayList();

    // TableView and UI elements that are linked from the FXML file
    @FXML
    private TableView<DsGame> tableView;
//----------------------------------------------------------
    // TableView specified columns
    @FXML
...
//----------------------------------------------------------
    ...
    /**
     * Loads all DS games from the database into the observable list.
     */
    ...
    /**
     * Filters the TableView to display only ds games matching the selected genre.
     */
    ...
    /**
     * Lets user choose if they want to add ds games manually or load ds games from a database via file path
     */
//----------------------------------------------------------------------------------------------------------------------
     ...
     * Validates that the user only enters the correct information/inputs for each piece of data before it's added to
     * the system
     *
     * Validates empty inputs, invalid year, and duplicate ds game titles
     */
     ...
     *
     * @param message the message that displays within the alert
     */
...
//----------------------------------------------------------------------------------------------------------------------
    /**
     * Refreshes the tableView by reloading ds game data from the database
     */
...
//----------------------------------------------------------------------------------------------------------------------
     ...
     * Validates user inputs before being saved to the database
     *
     * users can edit ds game information such as the title, developer, genre, year, multiplayer status, and rating.
     */
...
//----------------------------------------------------------------------------------------------------------------------
    /**
     * Removes Ds game and its data if existing, User must select Ds game first before removing
     * Updates database after removing
     */
...
//----------------------------------------------------------------------------------------------------------------------
     ...
     * The purpose of this class is to store information of each DS Game entered into the system. This information
     * includes storing data such as the DS Game title, developer, genre, release year, rating and whether the DS game
     * has multiplayer support.This class is important to the overall application because it allows for easy management
     * and organization of Ds Game information.
     */

    /**
     * Describes a ds game within the system
     * Stores ds game information such as the title, developer, genre, release year, multiplayer support and rating.
     */
    public static class DsGame {
        ...
        /**
         * Constructs a ds game object without an ID
         * Has its use when creating a new game before its stored to the database
         *
         * @param title the title of the ds game
         * @param developer the developer name of the ds game
         * @param genre the genre of the ds game
         * @param releaseYear the release year of the ds game
         * @param multiplayerSupport whether the game has multiplayer support
         * @param rating the rating of the ds game
         */
        ...
        /**
         * Constructs a ds game object with an ID
         *
         * @param id the unique identifier of the ds game
         * @param title the title of the ds game
         * @param developer the developer name of the ds game
         * @param genre the genre of the ds game
         * @param releaseYear the release year of the ds game
        ...
        /**
         * Sets up the genre of the ds game
         *
         * @param genre the genre of the ds game
         */
        ...
        /**
         * Sets up the release year of the ds game
         *
         * @param releaseYear the release year of the ds game
         */
        ...
        /**
         * Sets up the multiplayer support status of the ds game
         *
         * @param multiplayerSupport whether the game has multiplayer support
         */
        ...
        /**
         * Sets up the rating of the ds game
         *
         * @param rating the rating of the ds game
         */
    ...
    //------------------------------------------------------------------------------------------------------------------
        /**
         * Returns the ds game ID
         *
         * @return the unique identifier of the ds game
         */
        public int getId() { return id; }

        /**
         * Returns the ds game title
         *
         * @return the title of the ds game
         */
        public String getTitle() { return title; }

        /**
         * Returns the ds game developer
         *
         * @return the developer of the ds game
         */
        public String getDeveloper() { return developer; }

        /**
         * Returns the ds game genre
         *
         * @return the genre of the ds game
         */
        public String getGenre() { return genre; }

        /**
         * Returns the ds games release year
         *
         * @return the release year of the ds game
         */
        public int getReleaseYear() { return releaseYear; }

        /**
         * Returns the ds game multiplayer status as a string
         *
         * @return "Yes" if the ds game has multiplayer support and "No" if it does not support multiplayer.
         */
        public String getMultiplayerString() { return multiplayerSupport ? "Yes" : "No"; }

        /**
         * Returns the ds games rating
         *
         * @return rating of the ds game as "E", "T", or "M"
         */
